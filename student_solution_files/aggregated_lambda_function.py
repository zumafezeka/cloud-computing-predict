...
def lambda_handler(event, context):
    ...
    # email_text = dec_dict['message'] + '\n\n' + dec_dict['email']
    email_text =  email_response(dec_dict['name'], ['github', 'git', 'Git',
                                                'GitHub', 'projects',
                                                'portfolio', 'Portfolio', 'C.V', 'resume', 'Curriculum Vitae',
                                           'Resume', 'CV'], phrase, sentiment)
